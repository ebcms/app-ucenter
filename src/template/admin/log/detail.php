...
<dl>
    <dd>
        <span class="mr-3"><b>IP:</b> <code>{$log.ip}</code></span>
        <span class="mr-3"><b>时间:</b> <code>{:date('Y-m-d H:i:s', $log['record_time'])}</code></span>
        <span class="mr-3"><b>用户ID:</b> <code>{$log.user_id}</code></span>
    </dd>
